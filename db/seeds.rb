...
Item.destroy_all
20.times do
    item = Item.create!(title: Faker::Name.unique.first_name, description: Faker::Lorem.sentence(5), price: Faker::Number.decimal(2), image_url: image.sample)
end
...
20.times do
    cartitem = Cartitem.create!(cart: Cart.all.sample, item: Item.all.sample)
end
...
20.times do
    orderitem = Orderitem.create!(order: Order.all.sample, item: Item.all.sample)
end
